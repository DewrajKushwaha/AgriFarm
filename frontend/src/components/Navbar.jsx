        ...
        <header className="bg-white shadow-md">
          <div className="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav className="space-x-4">
              <Link to="/" className="text-gray-900 hover:text-black hover:font-bold">Market Data</Link>
              ...
              <Link to="/Login" className="text-gray-900 hover:text-black hover:font-bold">Login/Sign-Up</Link>
            </nav>
